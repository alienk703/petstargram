...
class Pet < ActiveRecord::Base
	...
	def self.followers
		web_contents = JSON.parse(open('https://api.instagram.com/v1/users/27467826/?access_token=137405.467ede5.e1202bb2c76843eea5516617757369c6'){|f| f.read })
		fans = web_contents["data"]
		followers = []
		followers << {"counts" => fans["counts"]["followed_by"]}
	end
...
# profile << { "picture" => account["profile_picture"] , "username" => account["username"], "counts" => account["counts"]["followed_by"]}